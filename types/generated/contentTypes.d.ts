...
export interface ApiComiteeComitee extends Schema.SingleType {
  collectionName: 'comitees';
  info: {
...
export interface ApiConferenceDateConferenceDate extends Schema.SingleType {
  collectionName: 'conference_dates';
  info: {
    singularName: 'conference-date';
    pluralName: 'conference-dates';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::conference-date.conference-date',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::comitee.comitee': ApiComiteeComitee;
      'api::conference-date.conference-date': ApiConferenceDateConferenceDate;
